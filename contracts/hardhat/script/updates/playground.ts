...
async function updateTokenRegistryToV2() {
  ...
  const tokenExample = await ethers.getContractFactory('EnygmaTokenExample');
...
async function deployEnygma() {

  const enygmaHandler = await ethers.getContractFactory('ParticipantStorageV2');
